...
set INCLUDE_DIRS= /I ../src/ /I ../sdl2/include/ /I../sdl2_image/include
set LIBRARY_LINK= SDL2.lib SDL2main.lib SDL2_image.lib
set LIBRARY_PATHS= /LIBPATH:../sdl2/lib/x64/ /LIBPATH:../sdl2_image/lib/x64/
